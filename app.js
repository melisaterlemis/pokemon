...
const createPokemonBox = (pokemon) => {
  ...
  />
   ...
   <div class="tab">
   <button class="tablinks active" onclick="openCity(event, 'stats', ${idPoke})">About</button>
   <button class="tablinks active" onclick="openCity(event, 'about', ${idPoke});
    move(${idPoke},${baseStat1},${baseStat2},${baseStat3},${baseStat4},${baseStat5},${baseStat6});
    ">Stats</button>
   <button class="tablinks active" onclick="openCity(event, 'moves', ${idPoke})">Moves</button>
   <button class="tablinks active" onclick="openCity(event, 'evolution', ${idPoke})">Evolution</button>
   <button class="tablinks active" onclick="openCity(event, 'location', ${idPoke})">Location</button>
   </div> 
